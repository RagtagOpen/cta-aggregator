Feature: Events
  ...
  Scenario: Retrieve an event
   ...
   Scenario: Create an event with contact, location, and script
    ...
    Given the system contains a script with uuid "dddddddd-1111-2222-3333-666666666666"
      ...
      "data": {
         ...
         "attributes": {
          ...
          "relationships": {
            ...
            "script": {
              "data": { "type": "scripts", "id": "dddddddd-1111-2222-3333-666666666666" }
            }
          }
       }
    }
    ...
    And the event has a script_id of "dddddddd-1111-2222-3333-666666666666"
   ...
   Scenario: Add script for event
    ...
    """
    When the client sends a PUT request to "/events/aaaaaaaa-1111-2222-3333-666666666666/relationships/script"
    Then the response status should be "204"
